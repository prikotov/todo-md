...
2. **Документация** (`docs/todo-md/`) — конвенции, справочники, шаблоны задач и эпиков, копируемые init-скриптом.
...
```
bin/
  todo-md-init               # CLI-команда инициализации (единственный исполняемый файл)
docs/
