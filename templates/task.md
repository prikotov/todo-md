---
# Metadata (Метаданные)
type: <fix|feat|build|chore|ci|docs|style|refactor|perf|test|revert>  # см. [TYPES.md](../docs/TYPES.md)
created: <YYYY-MM-DD>
...
status: <todo|in_progress|review|done|blocked|paused|cancelled>  # см. [STATUSES.md](../docs/STATUSES.md)
---
