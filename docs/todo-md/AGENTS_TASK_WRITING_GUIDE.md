...
Постановку можно оформить отдельным запросом на слияние (Pull Request, PR). Для начала реализации следуйте [порядку работы с задачами](../../todo/AGENTS.md#процесс-работы-с-задачами).
