...
type: epic
created: <YYYY-MM-DD>
due:  # плановый срок эпика, дата YYYY-MM-DD; см. [DATES.md](../reference/DATES.md)
started:  # дата перехода эпика в in_progress, YYYY-MM-DD; см. [DATES.md](../reference/DATES.md)
completed:  # дата перехода эпика в done, YYYY-MM-DD; см. [DATES.md](../reference/DATES.md)
